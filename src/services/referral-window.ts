...
export const SIGNUP_CUTOFF_DATE = '2026-10-20';
export const PAYOUT_DEADLINE_DATE = '2027-02-28';
...
export type TierRules = {
    below_floor: { min_ex_vat: null; max_ex_vat: number; reward_zar: number };
    tier_1: { min_ex_vat: number; max_ex_vat: number; reward_zar: number };
    tier_2: { min_ex_vat: number; max_ex_vat: null; reward_zar: number };
};
...
export const RESPONSE_INSTRUCTIONS: Record<ReferralWindow, string> = {
    pre_launch:
        "Campaign starts 1 June 2026. Hand the client their magic_link, explain how it'll work in the 3-step format, mention the tier rules and the 20 October signup deadline. Be upfront that no reward is payable yet.",
    active:
